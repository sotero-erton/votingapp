package br.com.sicredi.VotingApp.configuration;
...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("sicred-voting-of-agendas")
                .description(
                ...
                .termsOfServiceUrl("https://www.linkedin.com/in/erton-sotero-42440885/")
                .version("1.0")
                .contact(new Contact("",
                                     "",
                                     "sotero.erton@gmail.com"))
                .build();
    }

    @Bean
    public Docket customImplementation(ServletContext servletContext,
                                       @Value("${openapi.sicredVotingOfAgendas.base-path:}") String basePath) {
